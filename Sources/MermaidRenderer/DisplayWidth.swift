// Self-contained terminal display-width measurement — the `go-runewidth`
// equivalent mermaid-ascii relies on. Kept here so MermaidRenderer has no
// dependency on termdownCore. Operates on Unicode scalars (Go runes), summing
// per-scalar cell widths: 0 for combining/zero-width marks, 2 for East-Asian
